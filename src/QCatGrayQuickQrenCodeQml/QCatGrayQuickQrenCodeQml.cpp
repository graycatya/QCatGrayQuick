...
QCatGrayQuickQrenCodeQml::QCatGrayQuickQrenCodeQml(QQuickItem *parent)
    : QQuickPaintedItem(parent)
{
    InitProperty();
}

QCatGrayQuickQrenCodeQml::~QCatGrayQuickQrenCodeQml()
{

}

QImage QCatGrayQuickQrenCodeQml::getQrenImage()
{
...
void QCatGrayQuickQrenCodeQml::paint(QPainter *painter)
{
    if(m_sText.isEmpty())
    {
        return;
...
void QCatGrayQuickQrenCodeQml::InitProperty()
{
    m_eQrmode = MODE_8;
    m_eQrlevel = LEVEL_Q;
    m_bCasesen = true;
